            ...
            switch (type) {
                ...
                case "Maya|TEX_color_map":
                    ...
                    if (parameters.map !== undefined) {
                        parameters.map.encoding = LinearEncoding
                    }
                ...
                case "EmissiveColor":
                    ...
                    if (parameters.emissiveMap !== undefined) {
                        parameters.emissiveMap.encoding = LinearEncoding
                    }
                ...
                case "ReflectionColor":
                    ...
                    if (parameters.envMap !== undefined) {
                        parameters.envMap.mapping =
                            EquirectangularReflectionMapping
                        parameters.envMap.encoding = LinearEncoding
                    }
                ...
                case "SpecularColor":
                    ...
                    if (parameters.specularMap !== undefined) {
                        parameters.specularMap.encoding = LinearEncoding
                    }
                            ...
                            if (layerCurveNodes[i] === undefined) {
                                ...
                                if (modelID !== undefined) {
                                    ...
                                    if (rawModel === undefined) {
                                        console.warn(
                                            "FBXLoader: Encountered a unused curve.",
                                            child
                                        )
                                        return
                                    }
...
class BinaryParser {
    parse(buffer) {
        ...
        if (version < 6400) {
            throw new Error(
                "FBXLoader: FBX version not supported, FileVersion: " + version
            )
        }
...
function getData(polygonVertexIndex, polygonIndex, vertexIndex, infoObject) {
    ...
    switch (infoObject.mappingType) {
        ...
        default:
            console.warn(
                "FBXLoader: unknown attribute mapping type " +
