...
const PxCapsuleClimbingModeEnum = {
    ...
    eCONSTRAINED: lazy(_emscripten_enum_PxCapsuleClimbingModeEnum_eCONSTRAINED)
}
const PxControllerBehaviorFlagEnum = {
    eCCT_CAN_RIDE_ON_OBJECT: lazy(
        _emscripten_enum_PxControllerBehaviorFlagEnum_eCCT_CAN_RIDE_ON_OBJECT
    ),
    eCCT_SLIDE: lazy(_emscripten_enum_PxControllerBehaviorFlagEnum_eCCT_SLIDE),
...
const PxForceModeEnum = {
    ...
    eVELOCITY_CHANGE: lazy(_emscripten_enum_PxForceModeEnum_eVELOCITY_CHANGE),
    eACCELERATION: lazy(_emscripten_enum_PxForceModeEnum_eACCELERATION)
}

// actor flag enum
const PxActorFlagEnum = {
    eDISABLE_GRAVITY: lazy(_emscripten_enum_PxActorFlagEnum_eDISABLE_GRAVITY),
...
const PxArticulationJointTypeEnum = {
    ePRISMATIC: lazy(_emscripten_enum_PxArticulationJointTypeEnum_ePRISMATIC),
    eREVOLUTE: lazy(_emscripten_enum_PxArticulationJointTypeEnum_eREVOLUTE),
    eSPHERICAL: lazy(_emscripten_enum_PxArticulationJointTypeEnum_eSPHERICAL),
    eFIX: lazy(_emscripten_enum_PxArticulationJointTypeEnum_eFIX),
    eUNDEFINED: lazy(_emscripten_enum_PxArticulationJointTypeEnum_eUNDEFINED)
}
