...
class TransformControlsGizmo extends Object3D {
    constructor() {
        ...
        const lineGeometry2 = new CylinderGeometry(
            0.0075,
            0.0075,
            0.5 * ratio,
            3
        ...
        const pickerTranslate = {
            ...
            XYZ: showCentral
                ? [
                      [
                          new Mesh(
                              new OctahedronGeometry(0.2 * ratio, 0),
                              matInvisible
                          )
                      ]
                  ]
        ...
        const pickerRotate = {
            ...
            X: [
                [
                    new Mesh(
                        new TorusGeometry(0.5 * ratio, 0.1 * ratio, 4, 24),
                        matInvisible
                    ),
                    [0, 0, 0],
        ...
        const gizmoScale = {
            ...
            XYZ: [
                [
                    new Mesh(
                        new BoxGeometry(0.1 * ratio, 0.1 * ratio, 0.1 * ratio),
                        matWhiteTransparent.clone()
                    )
                ]
            ]
        ...
        const pickerScale = {
            ...
            XYZ: [
                [
                    new Mesh(
                        new BoxGeometry(0.2 * ratio, 0.2 * ratio, 0.2 * ratio),
                        matInvisible
                    ),
                    [0, 0, 0]
                ]
